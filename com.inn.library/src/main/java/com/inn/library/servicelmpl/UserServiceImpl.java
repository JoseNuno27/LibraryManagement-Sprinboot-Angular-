...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<String> signUp(Map<String, String> requestMap) {
        ...
        try {
            if (validateSignUp(requestMap)) {
                ...
                return LibraryUtils.getResponseEntity(LibraryConstant.INVALID_DATA, HttpStatus.BAD_REQUEST);
            }
        }catch (Exception ex)
        {
            ex.printStackTrace();
    ...
    private boolean validateSignUp(Map<String, String> requestMap) {
        if (requestMap.containsKey("name") && requestMap.containsKey("contactNumber") && requestMap.containsKey("password") && requestMap.containsKey("email")) {
            return true;
        }
